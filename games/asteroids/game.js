...
Game = {
  ...
  FSM: {
    ...
    waiting: function () {
      Text.renderText(window.ipad ? 'Touch Screen to Start' : 'Press Space to Start', 36, 192, Game.canvasHeight / 2);
    ...
    end_game: function () {
Text.renderText('GAME OVER', 50, 255, Game.canvasHeight / 2 + 10);
      if (this.timer == null) {
        this.timer = Date.now();
      }
...
Text.renderText(score_text, 18, Game.canvasWidth - score_text.length * 10 - 4, 20);
